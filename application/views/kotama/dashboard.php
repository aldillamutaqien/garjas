                ...
                <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
                    <div class="statistic-right-area notika-shadow mg-tb-30 sm-res-mg-t-0">
                        <div class="email-ctn-round">
                            <div class="email-rdn-hd">
                                <h2>Statistik Peserta Seldik Diktukba <?php echo $kotama->nama_kotama; ?></h2>
                            </div>
                 ...
                 <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
                    <div class="statistic-right-area notika-shadow mg-tb-30 sm-res-mg-t-0">
                        <div class="email-ctn-round">
                            <div class="email-rdn-hd">
                                <h2>Statistik Peserta Seldik Diktukpa <?php echo $kotama->nama_kotama; ?></h2>
                            </div>
                 ...
                 <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
                    <div class="statistic-right-area notika-shadow mg-tb-30 sm-res-mg-t-0">
                        <div class="email-ctn-round">
                            <div class="email-rdn-hd">
                                <h2>Statistik Peserta Seldik Diklapa I <?php echo $kotama->nama_kotama; ?></h2>
                            </div>
                 ...
                 <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
                    <div class="statistic-right-area notika-shadow mg-tb-30 sm-res-mg-t-0">
                        <div class="email-ctn-round">
                            <div class="email-rdn-hd">
                                <h2>Statistik Peserta Seldik Diklapa II <?php echo $kotama->nama_kotama; ?></h2>
                            </div>
