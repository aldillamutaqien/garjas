                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2><?php echo $kesatuan?></h2>
                                        <p><span class="bread-ntd"><?php echo @$kotama->nama_kotama?></span></p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            ...
                            <p><a href="<?php echo site_url("kotama/diktukba_satker/$kesatuan"); ?>">
                                     DIKTUKBA</a></p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            ...
                            <p><a href="<?php echo site_url("kotama/diktukpa_satker/$kesatuan"); ?>">
                                     DIKTUKPA</a></p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            ...
                            <p><a href="<?php echo site_url("kotama/diklapa1_satker/$kesatuan"); ?>">
                                     DIKLAPA I</a></p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            ...
                            <p><a href="<?php echo site_url("kotama/diklapa2_satker/$kesatuan"); ?>">
                                     DIKLAPA II</a></p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            ...
                            <p><a href="<?php echo site_url("kotama/datapersonel_satker/$kesatuan"); ?>">
                                     Jumlah Personel</a></p>
                        </div>
                        <div class="sparkline-bar-stats4">2,4,8,4,5,7,4,7,3,5,7,5</div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            ...
                            <p><a href="<?php echo site_url("kotama/datanilai_satker/$kesatuan"); ?>">
