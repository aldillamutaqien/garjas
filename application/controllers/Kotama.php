    ...
    function nilai_satker(){
         if(_is_user_login($this)){
            ...
            //foreach ($data["satker"] as $satker){
             ...
             $data["lulus_seldik_diktukba"] =  $this->seldik_model->get_lulus_diktukba_satker_kotama_this_year($data['kotama']->nama_kotama);
             print_r($data["lulus_seldik_diktukba"]);die();
            //}die();
