...
class Dataadmin extends CI_Controller {
	...
	public function index()
	{
		if(_is_user_login($this)){
            ...
            $data["users"] = $this->dataadmin_model->get_dataadmin_filter_by_flag_del();
    ...
    public function add_admin(){
        if(_is_user_login($this)){
        		...
        		}else
                {
                      ...
                      //  print_r($tanggal_lahir);die();
                        ...
                        // print_r($array);die();
                            ...
                            $this->common_model->data_insert("dataadmin",
                                array(
                                "nama"=>$nama,
                                "pangkat"=>$pangkat,
                                "korps"=>$korps,
                            ...
                            echo  '<script>alert("Data berhasil disimpan...");window.location = "'.site_url().'/dataadmin/";</script>
                                ';
            ...
            $data["user"] = $this->dataadmin_model->get_user()->result();
            $this->load->view("dataadmin/add_admin",$data);
        }
    }
